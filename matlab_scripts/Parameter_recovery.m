...
function Parameter_recovery
    ...
    [time_horizon, N, L, true_theta, true_theta0, init_grids] = generate_series(row, col, d, periods, density);

    % Regularization hyper-parameter.
    for lbd = 0.001%all_lambdas
        ...
        location_plot(L, N, d, true_theta, true_theta0, theta, theta0, 1, time_horizon(1:d,:));
        return;
